 ...
 */
  ...
  [1] = LAYOUT_ortho_5x15(
   ...
   ,OSM(MOD_LCTL|MOD_LSFT), LSFT(KC_LEFT), LSFT(KC_UP), LSFT(KC_DOWN), LSFT(KC_RGHT), LSFT(KC_SPC), _______, OSM(MOD_LCTL|MOD_LSFT), LSFT(KC_TAB), LSFT(KC_BSPC), LSFT(KC_DEL), OSM(MOD_LGUI), KC_MNXT, LSFT(KC_RALT), OSM(MOD_LCTL|MOD_LSFT)),
