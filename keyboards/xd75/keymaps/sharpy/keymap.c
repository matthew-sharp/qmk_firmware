 ...
 */
  ...
  [1] = LAYOUT_ortho_5x15(
   ...
   ,KC_UNDS, LSFT(KC_Q), LSFT(KC_I), LSFT(KC_E), LSFT(KC_A), LSFT(KC_Y), LSFT(KC_END), KC_DLR, LSFT(KC_PGDN), LSFT(KC_D), LSFT(KC_S), LSFT(KC_F), LSFT(KC_N), LSFT(KC_B), KC_SCLN
  ...
  [2] = LAYOUT_ortho_5x15(KC_NO, KC_4, KC_0, KC_1, KC_2, KC_3, KC_MUTE, MAGIC_HOST_NKRO, KC_NO, KC_7, KC_6, KC_5, KC_9, KC_8, _______, _______, KC_NO, KC_LT, KC_DLR, KC_GT, KC_NO, KC_VOLD, KC_NO, KC_MPRV, KC_INS, KC_LBRC, KC_AMPR, KC_RBRC, KC_PAUS, _______, KC_MINS, KC_BSLS, KC_LPRN, KC_DQUO, KC_RPRN, KC_HASH, KC_VOLU, KC_NO, KC_MNXT, KC_PERC, KC_LCBR, KC_EQL, KC_RCBR, KC_PIPE, KC_SCLN, KC_LSPO, KC_SLSH, KC_COLN, KC_ASTR, KC_PLUS, KC_NO, _______, _______, _______, KC_PSCR, KC_UNDS, KC_CIRC, KC_TILD, KC_NO, KC_RSPC, _______, _______, _______, _______, _______, _______, _______, _______, KC_NO, _______, _______, KC_APP, KC_NO, KC_NO, _______),
  [3] = LAYOUT_ortho_5x15(KC_NO, KC_NO, KC_SLSH, KC_ASTR, KC_MINS, KC_NO, KC_NO, RESET, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_COLN, KC_7, KC_8, KC_9, KC_PLUS, KC_CIRC, KC_NO, DEBUG, KC_NO, KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, _______, KC_TAB, KC_4, KC_5, KC_6, KC_EQL, KC_COMM, KC_NO, KC_NO, KC_NO, KC_NO, KC_F5, KC_F6, KC_F7, KC_F8, KC_NO, KC_NO, KC_1, KC_2, KC_3, KC_ENT, KC_NO, KC_NO, KC_UP, KC_NO, KC_NO, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_NO, KC_0, KC_0, KC_DOT, KC_ENT, KC_SPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO)
};
