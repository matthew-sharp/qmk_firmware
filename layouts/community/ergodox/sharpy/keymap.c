 ...
 * |        |NumLk |   +  |   =  |   *  |      |      |       |      |      |      |      |      |      |  TO 0  |
 * |--------+------+------+------+------+-------------|       |------+------+------+------+------+------+--------|
 * |        | Tab  |   7  |   2  |   4  |   6  |      |       |      |  F13 |  F1  |  F2  |  F3  |  F4  |  TT 3  |
 * |--------+------+------+------+------+------|      |       |      |------+------+------+------+------+--------|
 * |    -   |   8  |   0  |   1  |   3  |   5  |------|       |------|  F14 |  F5  |  F6  |  F7  |  F8  |        |
 * |--------+------+------+------+------+------|      |       |      |------+------+------+------+------+--------|
 * |Shft/Esc|   /  |   ,  |   9  |   .  |   :  |      |       |      |  F15 |  F9  |  F10 |  F11 |  F12 |Shft/Esc|
 * .--------+------+------+------+------+-------------.       .-------------+------+------+------+------+--------.
 *   |      |      |      |      |      |                                   |      |      |      |      |      |
 *   .----------------------------------.                                   .----------------------------------.
 *                                      .-------------.       .-------------.
 ...
 */
  ...
  [3] = LAYOUT_ergodox(
  // Left
   _______,          KC_NUMLOCK,KC_KP_PLUS,KC_EQUAL,KC_KP_ASTERISK,_______,_______
  ,_______,          KC_TAB,  KC_7,    KC_2,    KC_4,    KC_6,   _______
  ,KC_MINUS,         KC_8,    KC_0,    KC_1,    KC_3,    KC_5
  ,KC_LSPO,          KC_KP_SLASH,KC_COMMA,KC_9, KC_DOT,  KC_COLN,_______
  ...
  ,_______,           KC_F15,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_RSPC
                               ,_______, _______, _______, _______, _______
  ,_______, _______
  ,_______
  ,_______, _______,  _______),
